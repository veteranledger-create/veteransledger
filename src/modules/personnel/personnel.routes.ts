...
personnelRoutes.get("/",          authenticate, requireAdmin, listPersonnelValidator, handleValidation, ctrl.list.bind(ctrl));
personnelRoutes.get("/:id/preview", authenticate, requireAdmin, ctrl.preview.bind(ctrl));
personnelRoutes.get("/:id",         authenticate, requireAdmin, ctrl.get.bind(ctrl));
