...
function renderError(root, msg) {
  root.innerHTML = `
    <nav class="record-breadcrumb"><a href="/awards">← ${t("breadcrumb.backToAwards", null, "Back to Awards")}</a></nav>
    <div class="record-error">
      <div class="record-error__icon">✦</div>
      <div class="record-error__title">${t("error.awardNotFound", null, "Award Not Found")}</div>
